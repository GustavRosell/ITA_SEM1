...
8.1: En funktion der tager et array med tekst som input. 
Funktionen skal returnerer summen af længderne på alle tekster i arrayet.

8.2: En funktion der tager to arrays, og returnerer et nyt langt array hvor elementer fra de to arrays er sat sammen. 
Fx bliver [1, 2, 3] og [4, 5, 6] til [1, 2, 3, 4, 5, 6].

8.3: En funktion der tager to arrays med samme længde, og hvor begge indeholder tal. 
...
8.4: En funktion der tager et array med tekst som input. 
...
console.log("Sammenlagt nyt array af arr1 + arr2: \n" + combineArrays(["Jørgen, GMoney, Oskar "], ["Helle, Sofus, Selma"]) + "\n"); // Printer 'Jørgen, GMoney, Oskar Helle, Sofus, Selma'

console.log("----------------------------------------------------------------------------------------------------------------------------\n")

// Opgave 8.3:) En funktion der tager to arrays med samme længde, og hvor begge indeholder tal. 
// Funktionen skal returnerer et nyt array hvor tallene er lagt parvis sammen.
...
console.log("Sammenlagt nyt array af arr1 + arr2: \n" + combineArrSum([1, 2, 3], [4, 5, 6])); // Printer [5, 7, 9]
